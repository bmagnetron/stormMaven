...
public class NSESpout extends BaseRichSpout {
	
	private SpoutOutputCollector collector;
	private String url = "http://finance.google.com/finance/info?client=ig&q=NSE:HDFC";
//	private String url ="http://finance.google.com/finance/info?client=ig&q=NASDAQ:MSFT";
	@Override
